...
> 🇧🇷 Português: [User-Guide](User-Guide.md).

> **Note:** the UI strings are in Brazilian Portuguese (pt-BR) by design. This guide translates the concepts and button labels for English-speaking readers.
...
- [Export to iClips](#export-to-iclips)
