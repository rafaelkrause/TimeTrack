...
> 🇬🇧 Looking for the English version? See [Installation-EN](Installation-EN.md).

## Sumário

- [Pré-requisitos](#pré-requisitos)
- [Linux / macOS — com script](#linux--macos--com-script)
- [Linux / macOS — manual](#linux--macos--manual)
- [Windows — instalador NSIS](#windows--instalador-nsis)
- [Windows — manual](#windows--manual)
- [Gerar o instalador do zero](#gerar-o-instalador-do-zero)
- [Iniciar automaticamente](#iniciar-automaticamente)
- [Atualizar](#atualizar)
