...
> 🇬🇧 English: [Configuration-EN](Configuration-EN.md).
...
Porta HTTP local. Padrão `5000`. Altere se houver conflito com outro serviço (ex: `5050`).
...
> ⚠️ Isso **não** apaga seus dados em `data/`. Apenas a configuração.
